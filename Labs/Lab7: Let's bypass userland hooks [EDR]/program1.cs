/*	DYNAMIC INVOKE QUEUE USER APC PROCESS INJECTION
description: |
	Uses direct syscalls mapped via d/invoke
...
namespace DinvokeQUserAPCProcessInjection

{
    ...
    public class Program
    {
		...
		static void Main(string[] args)
        {
			...
			// Sleep to evade in-memory scan an checks if the emulator did not fast forward through the sleep instruction
